...
@Slf4j
@Service
public class BueServiceImp implements BueService {
    ...
    @Override
    @Transactional
    public String updatingDocument(File file, String orderId, String companyId) throws Exception {
        return null;
    }
    ...
    @Override
    public Peb generatePeb(String car) {
        return null;
        // return pebGenerator.generateData(car);
    }
